...
*Install packages dplyr and data.table in R (Use install.packages(“nameofpackage”) )
*Uzip the data in your working directory (the directory you will be running the run_analysis.R code)
The run_analysis.R specifically uses the following data: “X_train.txt”, “y_train.txt”, “subject_train.txt”, “X_test.txt”, “y_test.txt”, “subject_test.txt”, “activity_labels.txt”, “features.txt”
...
*Selects column names that calculates means and std of features only
